...
extension PlayAudioVC : AVAudioPlayerDelegate {
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false,
                   volume: Bool = false, distortion: Bool = false, param: Float = 1.0 ) {
        ...
        echoNode.delayTime = 0.3
        echoNode.feedback = 50 * param
        ...
        if volume {
            audioEngine.mainMixerNode.outputVolume = param/2
        }
        ...
        audioPlayerNode.scheduleFile(audioFile, at: nil) {
            ...
            self.stopTimer = Timer(timeInterval: delayInSeconds, target: self, selector: #selector(PlayAudioVC.stopAudio), userInfo: nil, repeats: false)
